        ...
        extend: {
            colors: {
                ...
                qihe: {
                    ...
                    'media-frame': '#181a1e',
                    text: '#ecebe7',
                    'text-secondary': '#8d9098',
                    'text-tertiary': '#5e626a',
                    border: 'rgba(235, 234, 227, 0.105)',
                    'border-strong': 'rgba(235, 234, 227, 0.21)',
                    silver: '#afb1b4',
                    'silver-strong': '#dedfdf',
                }
            },
            fontFamily: {
            ...
            typography: ({ theme }) => ({
                DEFAULT: {
                    css: {
                        ...
                        '--tw-prose-lead': theme('colors.mutedForeground'),
                        '--tw-prose-links': theme('colors.accent'),
                        '--tw-prose-bold': theme('colors.foreground'),
                        '--tw-prose-counters': theme('colors.mutedForeground'),
                        '--tw-prose-bullets': theme('colors.mutedForeground'),
